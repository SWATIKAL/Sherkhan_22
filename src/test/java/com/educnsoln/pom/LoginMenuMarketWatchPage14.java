...
public class LoginMenuMarketWatchPage14 extends com.educnsoln.base.CommonFunctions {
	...
	public static void dashBoardDisplayCheck() {
		driver.findElement(By.xpath(PropertyReader.getProperty("MarketWatchButton_xpath"))).click();
