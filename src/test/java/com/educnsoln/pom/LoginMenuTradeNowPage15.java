...
public class LoginMenuTradeNowPage15 extends com.educnsoln.base.CommonFunctions {
	...
	public static void dashBoardDisplayCheck() {
		driver.findElement(By.xpath(PropertyReader.getProperty("TradeNow_xpath"))).click();
		
	}

/*	public static void cickElement(String TradeNow_xpath) {
		driver.findElement(By.xpath(PropertyReader.getProperty("TradeNow_xpath"))).click();
